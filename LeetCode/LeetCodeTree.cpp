...
/// </summary>
bool LeetCode::isQuadTreeLeaf(vector<vector<int>>& grid, int up, int left, int down, int right)
{
...
/// Leet code #427. Construct Quad Tree
/// </summary>
QuadNode* LeetCode::constructQuadTree(vector<vector<int>>& grid, int up, int left, int down, int right)
{
...
/// </summary>
QuadNode* LeetCode::constructQuadTree(vector<vector<int>>& grid)
{
    QuadNode* result = nullptr;
...
/// </summary>
QuadNode* LeetCode::collapse(QuadNode* quadTree)
{
...
/// Leet code #558. Quad Tree Intersection
/// </summary>
QuadNode* LeetCode::clone(QuadNode* quadTree)
{
    QuadNode* result = nullptr;
...
/// </summary>
QuadNode* LeetCode::intersect(QuadNode* quadTree1, QuadNode* quadTree2)
{
    QuadNode* result = nullptr;
