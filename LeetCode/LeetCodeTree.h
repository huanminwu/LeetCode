...
/// </summary>
    ...
    /// </summary>
    long long minIncrease_dfs(int node, int parent, vector<vector<int>>& neighbors, vector<int>& cost, vector<long long>&max_path);

    /// <summary>
    /// Leet Code 3593. Minimum Increments to Equalize Leaf Paths
    /// </summary>
    int minIncrease_inc(int node, int parent, vector<vector<int>>& neighbors, vector<int>& cost, vector<long long>& max_path, long long inc);
    ...
    /// </summary>
    int maxSubgraphScoreDFSInPath(int parent, int node, vector<vector<int>>& neighbors, 
        vector<int>& good, vector<int>&inPathScores);

    /// <summary>
    /// Leet Code 3772. Maximum Subgraph Score in a Tree
    /// </summary>
    int maxSubgraphScoreDFSOutPath(int parent, int node, vector<vector<int>>& neighbors,
    ...
    /// </summary>
    vector<int> specialNodes(int root, vector<vector<int>>& neighbors);
    ...
    /// </summary>
    void maxSum(vector<pair<TreeNode*, int>>& nodes, int curr, int prev, vector<int>& parent,
    ...
    /// </summary>
    long long finishTimeI(int node, int parent, vector<vector<int>>& children, vector<int>& baseTime);
    ...
    /// 8. 1 <= baseTime[i] <= 10^5
    /// </summary>
    long long finishTimeI(int n, vector<vector<int>>& edges, vector<int>& baseTime);

    /// <summary>
    /// Leet Code #3967. Finish Time of Tasks II
    /// </summary>
    long long finishTimeII_InPath(int node, int parent, vector<vector<int>>& children, vector<int>& baseTime, 
        vector<set<pair<long long, int>>>& minTimes, vector<set<pair<long long, int>>>& maxTimes);

    /// <summary>
    /// Leet Code #3967. Finish Time of Tasks II
    /// </summary>
    long long finishTimeII_OutPath(int node, int parent, vector<vector<int>>& children, vector<int>& baseTime,
