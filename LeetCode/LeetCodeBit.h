...
#pragma region BitOperation
    ...
    /// <summary>
    /// Leet Code 3806. Maximum Bitwise AND After Increment Operations
    ///
    /// Hard
    ///
    ...
    /// Increase nums[0] = 3 to 6 using 3 operations, and increase 
    /// nums[2] = 2 to 6 using 4 operations.
    /// The total number of operations used is 7, which is not greater 
    /// than k = 8.
    ...
    /// Increase nums[0] = 1 to 4 using 3 operations, increase nums[1] = 2 
    /// to 4 using 2 operations, and keep nums[3] = 4.
    ...
    /// The total number of operations used is 2, which is not greater 
    /// than k = 3.
    /// The two chosen values become[2, 2], and their bitwise AND is 2, 
    /// which is the maximum possible.
    ///
    /// Constraints :
