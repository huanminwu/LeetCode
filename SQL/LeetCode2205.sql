-----------------------------------------------------------------------
--- Leet Code 2205. The Number of Users That Are Eligible for Discount
---                                                                                   
--- Easy
---
--- SQL Schema
...
--- inclusive interval of time [startDate, endDate] with at least 
--- minAmount amount.
---
--- Write an SQL query to report the number of users that are eligible 
--- for a discount.
---
