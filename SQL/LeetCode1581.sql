-----------------------------------------------------------------------
---  Leet code #1581. Customer Who Visited but Did Not Make Any Transactions
--- 
---  Easy
---
---  SQL Schema
...
---  they did not make any transactions, and during one visit they made 3 
---  transactions.
...
SELECT
    A.customer_id,
    count_no_trans = COUNT(DISTINCT A.visit_id)
FROM
    Visits AS A
LEFT OUTER JOIN 
(
